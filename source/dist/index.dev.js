...
// src/utils/debug.ts
var dbg = (_channelName) => {
  return {
    log: console.log,
    extend: function(_channelName2) {
      return this;
    }
  };
};
var err = (_channelName) => {
  return {
    log: console.debug,
    extend: function(_channelName2) {
      return this;
...
var ReactResizeObserver = (props) => {
  const style2 = (0, import_react.useMemo)(
    () => ({
      position: "absolute",
      top: 0,
      left: 0,
  ...
  const firstTime = (0, import_react.useRef)(true);
...
var debug = dbg("CSSVariableWatch");
var WRAPPER_STYLE = {
  position: "absolute",
  pointerEvents: "none",
  width: 0,
...
var useRerender = () => {
  const [state, setState] = (0, import_react7.useState)(0);
  return [
    state,
...
function FilterIcon(props) {
  var _a;
  const [rendered, setRendered] = (0, import_react17.useState)(true);
...
var InfiniteTableColumnHeaderFilterContext = import_react18.default.createContext(null);
...
function useCellRendering(param) {
  ...
  const scrollTopMaxRef = (0, import_react37.useRef)(0);
  ...
  const renderCell = (0, import_react37.useCallback)(
    (params) => {
      const {
        rowIndex,
        colIndex,
...
function FocusDetect() {
  ...
  const onFocus = (0, import_react58.useCallback)(() => __async(this, null, function* () {
    const context = {
      getDataSourceState,
      getComputed,
      actions,
